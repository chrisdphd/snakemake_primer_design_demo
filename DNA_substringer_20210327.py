...
.. module:: DNA_substringer.py
    ...
    :synopsis: Enumerates a set of primers (substrings of the dna sequence), (many per 3' end),
...
def workflow(fh, Na, Mg, dNTPs, saltcorr, dnac1, dnac2):
...
def parseArgs():
    ...
    :type arg_list: list.
    """
    argparser = ArgumentParser(description='Makes/enumerates/generates oligos suitable for PCR application. No particular filtering other than GC/Tm and homopolymer check')
    # the arguments:
